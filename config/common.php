...
return [
    ...
    // Spiral Core Factory
    SpiralFactoryInterface::class => static function (Injector $injector) {
        return new CycleDynamicFactory($injector);
    },
    ...
    // Schema
    SchemaInterface::class => static function (SchemaProviderInterface $schemaProvider) {
        $schema = $schemaProvider->read();
        if ($schema === null) {
